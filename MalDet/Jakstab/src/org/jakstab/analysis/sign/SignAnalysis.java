...
public class SignAnalysis implements ConfigurableProgramAnalysis {
	...
	/*
	 * @see org.jakstab.analysis.ConfigurableProgramAnalysis#post(org.jakstab.analysis.AbstractState, org.jakstab.analysis.CFAEdge, org.jakstab.analysis.Precision)
	 */
	@Override
	public Set<AbstractState> post(final AbstractState state, CFAEdge edge, Precision precision) {
		...
		return statement.accept(new DefaultStatementVisitor<Set<AbstractState>>() {
			...
			public Set<AbstractState> visit(RTLAssignment stmt) {
				...
				SignElement evaledRhs = s.abstractEval(rhs);
