...
public class BinaryInputBuffer{
   ...
   /** Creates a BinaryInputBuffer from the given InputStream and buffers all the available data.
     ...
     */
   public BinaryInputBuffer(java.io.InputStream input) throws java.io.IOException{
...
/////////////////////////////
   ...
   public void zero(long length) throws java.io.IOException{
      if ((current+length)>=size || length<0)
         throw new java.io.IOException("BinaryInputBuffer.zero: Invalid length parameter");
   ...
   /**
    * Returns a reference to the whole buffered data as a byte array.
