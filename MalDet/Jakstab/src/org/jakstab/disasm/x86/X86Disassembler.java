...
public class X86Disassembler implements Disassembler, X86Opcodes {
	...
	private X86Disassembler(byte[] code, X86InstructionFactory factory) {
		this.code = code;
	 ...
	 */
	public X86Disassembler(byte[] code) {
		this(code, new X86InstructionFactoryImpl());
	}
	
	/**
	 * Creates a new disassembler for an executable image. 
	 * 
	 * @param image The executable image on which the disassembler 
	 *              will operate.
	 */
	public X86Disassembler(ExecutableImage image) {
		this(image.getByteArray());
	}
